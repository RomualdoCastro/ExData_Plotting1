...
# Print plot4 4 figures arranged in 2 rows and 2 columns

par(mfrow=c(2,2))
plot(df$DT,df$Global_active_power, type="l", xlab="",ylab="Global Active Power " ,cex.lab=0.5,cex.axis=0.7,lty=1)
plot(df$DT,df$Voltage, type="l", xlab="datetime",ylab="Voltage" ,cex.lab=0.5,cex.axis=0.7,lty=1)

df$Sub_metering_1<-as.numeric(df$Sub_metering_1)
df$Sub_metering_2<-as.numeric(df$Sub_metering_2)
df$Sub_metering_3<-as.numeric(df$Sub_metering_3)
plot(df$DT,df$Sub_metering_1, type="l" ,lty=1, xlab="",ylab="Energy Sub meetering" ,cex.lab=0.5,cex.axis=0.7)
...
plot(df$DT,df$Global_reactive_power, type="l", xlab="datetime",ylab="Global_reactive_power" ,cex.lab=0.5,cex.axis=0.4,lty=1)
